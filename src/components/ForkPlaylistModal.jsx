    ...
    <div className="modal-overlay" role="dialog" aria-modal="true">
      <div className="fork-modal">
        <div className="fork-header">
          ...
          <button className="fork-close" onClick={onClose} aria-label="Close">
            ✕
          </button>
        </div>
        ...
        <div className="fork-content">
          ...
          <div className="fork-info">
            ...
            <p>
              This will create a copy of this playlist in your Spotify account
            </p>
          </div>
            ...
            <label className="checkbox-label" style={{ alignItems: "center" }}>
              ...
              <div className="checkbox-text">
                ...
                <p className="help-text">
                  {isPublic
                    ? "Others can see this playlist on your Spotify profile"
