...
const ProfileComponent = ({
  ...
  const [userListModalType, setUserListModalType] = useState("followers");
      ...
      <div className="profile-header">
        ...
        {isOwnProfile && (
          <div className="profile-action-buttons">
            ...
            <button
              className={`circular-action-btn copy-link-btn${
                copySuccess ? " copied" : ""
              }`}
              onClick={async () => {
        ...
        >
          ...
          <div className="profile-meta">
            ...
            {profile?.showSpotifyStatus !== false &&
          ...
          >
            ...
            >
              ...
              <span
                ...
                style={{ color: currentTheme.textSecondary, display: "block" }}
              >
                Posts
              </span>
            </div>
          ...
          {profile?.spotifyItems &&
            profile.spotifyItems.length > 0 &&
            !showMusicSelector && (
            ...
            >
              ...
              {postsLoading ? (
                ...
                <div className="posts-grid">
                  {posts.map((post) => (
                    <PostCard key={post.id} post={post} theme={currentTheme} />
                  ))}
                </div>
              ) : (
                  ...
                  <div className="no-posts-content">
                    ...
                    {isOwnProfile && (
                      <button
                        ...
                        onMouseLeave={(e) =>
                          (e.target.style.background = currentTheme.buttonBg)
                        }
                      >
