    ...
    <div className={`concept-post-card ${isDraft ? "post-draft" : ""}`}>
      ...
      <div className="concept-post-header">
        ...
        <div className="header-right">
          ...
          <button className="post-menu-button" onClick={() => setShowPostModal(true)}>
      ...
      <div className="concept-post-footer">
        ...
        {!isDraft && (
          <div className="concept-actions">
            <button className="concept-action-btn comment-btn" onClick={handleComment}>
            ...
            <button className="concept-action-btn share-btn" onClick={handleShare}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-content">
              <button className="modal-option copy" onClick={handleCopyLink}>
                ...
                {linkCopied && (
                  <svg className="check-icon" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
