  ...
  const carouselData = [
    {
      ...
      subtitle:
        "Stream millions of songs and discover new favorites across all your devices.",
      gradient: "gradient-1",
    },
    {
      ...
      subtitle:
        "Experience instant playback with our high-quality audio streaming technology.",
      gradient: "gradient-2",
    },
    {
      ...
      subtitle:
        "Your listening data and personal information are always protected.",
      gradient: "gradient-3",
    },
    {
    ...
    },
    {
      ...
      subtitle:
        "Seamlessly sync your music between phone, tablet, and desktop.",
      gradient: "gradient-5",
    },
  ];
    ...
    <div className="login-container">
      ...
      <div className="auth-panel">
        <div className="auth-form-wrapper">
          ...
          {/* Title */}
          <h1 className="auth-title">{isLogin ? "Log in " : "Sign Up"}</h1>
          <p className="auth-subtitle">
            {isLogin
              ? "Welcome back! Select method to log in:"
              : "Join us today! Select method to sign up:"}
          </p>
          ...
          {carouselData.map((slide, index) => (
            ...
            >
              <div className="carousel-content">
                ...
                {/* Content */}
                <div className="carousel-icon-wrapper">{slide.icon}</div>
